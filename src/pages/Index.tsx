...
export default function Index() {
  ...
  const pricingPlans = [
    {
      ...
      period: 'в месяц',
      features: [
        '4 выезда массажиста в месяц',
        'До 20 сотрудников',
        'Базовый массаж (15 мин)',
        'Гибкий график',
    ...
    },
    {
      ...
      features: [
        '8 выездов в месяц',
        'До 40 сотрудников',
        'Массаж + групповые занятия йогой (2 раза в неделю)',
        'Расширенный массаж (20-30 мин)',
  ...
  const faqs = [
    {
      question: 'Как быстро можно начать программу well-being?',
    ...
    },
    {
      ...
      answer: 'Массаж: 15-30 минут на человека. Групповые занятия: 45-60 минут. Мы подстраиваемся под ваш рабочий график, чтобы минимально влиять на рабочий процесс.'
    },
    {
      question: 'Есть ли у ваших специалистов сертификаты?',
      answer: 'Все наши специалисты имеют профильное образование, сертификаты государственного образца и опыт работы от 3 лет. Мы регулярно проводим повышение квалификации команды.'
    }
  ];
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-2xl font-bold">Офис Дзен</h1>
            </div>
