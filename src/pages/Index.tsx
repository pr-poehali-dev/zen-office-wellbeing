        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <a href="#" className="flex items-center gap-0 group">
              ...
              <h1 className="tracking-tight bg-gradient-to-r from-[#51a700] via-[#7ddb00] to-[#51a700] bg-clip-text text-transparent bg-[length:200%_auto] animate-gradient font-semibold text-3xl transition-all duration-300 group-hover:drop-shadow-[0_0_8px_rgba(81,167,0,0.5)]">
                фисДзен
              </h1>
            </a>
