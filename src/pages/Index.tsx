        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <a href="#" className="flex items-center gap-0 group">
              ...
              <h1 className="text-2xl tracking-tight bg-gradient-to-r from-[#51a700a6] via-[#7ddb00] to-[#51a700a6] bg-clip-text bg-[length:200%_auto] animate-gradient font-semibold">
                фисДзен
              </h1>
            </a>
